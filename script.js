...
(function() {
  ...
  const VENDORS = [
    { name: 'AWS',        iconId: 'amazonaws',      color: '#f59e0b', localColor: 'Assets/aws.svg',         localWhite: 'Assets/aws.svg' },
    { name: 'Azure',      iconId: 'microsoftazure', color: '#3b82f6', localColor: 'Assets/azure.svg',       localWhite: 'Assets/azure.svg' },
    { name: 'ServiceNow', iconId: 'servicenow',     color: '#22c55e', localColor: 'Assets/servicenow.svg',  localWhite: 'Assets/servicenow.svg' },
